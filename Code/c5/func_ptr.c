/* funcptr.c -- uses function pointers */
#include <stdio.h>
#include <string.h>
#include <ctype.h>
...
void ToLower(char *);	// convert string to lowcase
...
char showmenu(void)
{
	...
	puts("u) uppercase		l) lowcase");
	puts("t) transposed case 	o) original case");
	puts("n) next string");
	ans = getchar();	// gets response
...
void Dummy(char * str) 41     return 0;

{
	// leaves string uchanged 
}
